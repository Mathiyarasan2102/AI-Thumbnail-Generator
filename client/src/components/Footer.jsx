...
export default function Footer() {
    return <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
        <Motion.div
        ...
        >
            ...
            {footerData.map((section, index) => <div key={index}>
                <p className="text-slate-100 font-semibold">{section.title}</p>
                <ul className="mt-2 space-y-2">
                    {section.links.map((link, index2) => <li key={index2}>
        ...
        >
            ...
            <p className="mt-3 text-center">&copy; {(/* @__PURE__ */ new Date()).getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">Thumblify - Mathiyarasan.P</a></p>
        </Motion.div>
    </footer>;
}
