...
export default function FeaturesSection() {
  return <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature, index) => <motion.div
    key={index}
  ...
  >
                        <img className="h-full w-auto" src="/assets/features-showcase-1.png" alt="features showcase" width={1e3} height={500} />
                    </motion.div>
                    <motion.div
  ...
  >
                        <img src="/assets/features-showcase-2.png" alt="features showcase" width={1e3} height={500} className="hover:-translate-y-0.5 transition duration-300" />
