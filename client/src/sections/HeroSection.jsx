...
export default function HeroSection() {
  ...
  return <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
  ...
  >
        Stop wasting hours on design. Get high-converting thumbnails in seconds with our advance AI.
      </motion.p>
      <motion.div
  ...
  >
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 md:gap-14 mt-12">
        {specialFeatures.map((feature, index) => <motion.p
