...
export default function TestimonialSection() {
  return <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <Marquee className="max-w-5xl mx-auto mt-11" gradient={true} speed={25} gradientColor="#000">
                <div className="flex items-center justify-center py-5 overflow-hidden">
                    {[...testimonialsData, ...testimonialsData].map((testimonial, index) => <TestimonialCard key={index} index={index} testimonial={testimonial} />)}
                </div>
            </Marquee>
